    ...
    return (
        <div name="timeline"
            ...
            <div className='max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full'>
                ...
                <div className='py-8'>
                    <p className="text-4xl inline justify-center font-bold border-b-4 border-gray-500 text-white p-1/2">Professional Timeline</p>
                </div>
                <VerticalTimeline>
                        ...
                        return (
                            ...
                            >
                                <div className="flex flex-col justify-evenly items-center">
                                    <h4 className="font-bold vertical-timeline-element-title">{element.title}</h4>
                                    <h5 className="vertical-timeline-element-subtitle">
                                    <FaLocationDot className="inline-block mr-1" />{element.location}
                                    </h5>
                                </div>
